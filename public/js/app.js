...
window.pluralize = __webpack_require__(44);

window.Vue = __webpack_require__(31);

window.GoogleMapsLoader = __webpack_require__(34);
...
Vue.component('point-of-interest', __webpack_require__(35));
...
Component.options.__file = "resources/assets/js/components/MarkerComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bf3ba908", Component.options)
  } else {
    hotAPI.reload("data-v-bf3ba908", Component.options)
' + '  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    emitName: function emitName() {
      this.$emit('emitname', { name: this.markerName, id: this.id });
    }
  },
...
var render = function() {
  ...
  return _c("div", { staticClass: "marker" }, [
    _c("h3", [_vm._v(_vm._s(_vm.markerName))]),
    _vm._v(" "),
    _c("input", {
      directives: [
        {
          name: "model",
          rawName: "v-model",
          value: _vm.markerName,
          expression: "markerName"
        }
      ],
      attrs: { type: "text" },
      domProps: { value: _vm.markerName },
      on: {
        keyup: _vm.emitName,
        input: function($event) {
          ...
          _vm.markerName = $event.target.value
        }
      }
    }),
    _vm._v(" "),
    _c("pre", [
      _vm._v(
        "    lat: " + _vm._s(_vm.lat) + ", lng: " + _vm._s(_vm.lng) + "\n  "
      )
    ])
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-bf3ba908", module.exports)
  }
}
